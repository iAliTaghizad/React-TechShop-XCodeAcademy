import {Flex, Circle, Box, Image, Badge, useColorModeValue, Icon, Button, Tooltip, Stack, Link, HStack, Text, LightMode} from "@chakra-ui/react"
  ...
  return (
    <Stack p={2} spacing={'3px'} bg="useColorModeValue('white', 'gray.800')" minW={'240px'} h={'450px'} borderWidth={'1px'} rounded={'lg'} shadow={'lg'} position={'relative'}>
      ...
      <Box flex={1} maxH={5} alignItems={'baseline'} >
        {product.stock <= 0 && (<Badge rounded={'full'} px={2} fontSize={'0.8em'} colorScheme="red">Sold Out</Badge>)}
        {product.isNew && (<Badge rounded={'full'} px={2} fontSize={'0.8em'} colorScheme="green">New</Badge>)}
      </Box>
